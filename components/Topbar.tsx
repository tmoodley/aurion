          ...
          {user ? (
            <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
              ...
              <button
                ...
                style={{ display: 'flex', alignItems: 'center', gap: 6, padding: '5px 12px', background: 'transparent', border: '1px solid rgba(224,82,82,0.35)', borderRadius: 4, color: 'var(--red)', fontFamily: 'var(--font-mono)', fontSize: 11, cursor: 'pointer', letterSpacing: '0.04em', transition: 'background 0.15s' }}
